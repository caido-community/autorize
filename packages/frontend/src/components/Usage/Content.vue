    ...
    <section id="queue-settings">
      ...
      <div class="space-y-4">
        ...
        <div class="border border-surface-700 rounded p-4">
          ...
          <p class="text-surface-300 text-sm">
            When enabled, Autorize will add the defined mutations to the
            original request and send it again. Disable this if you run into
            issues related to duplication of data.
          </p>
          <p class="text-surface-300 text-sm mt-2">
